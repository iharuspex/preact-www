...
Вы новичок в Preact? Не знакомы с Virtual DOM? Загляните в [учебник](/tutorial).

Это руководство поможет вам приступить к разработке приложений на Preact, используя 3 популярных варианта.
Если вы новичок в Preact, мы рекомендуем начать с [Preact CLI](#best-practices-powered-by-preact-cli).
...
Preact собран для использования непосредственно в браузере и не требует какой-либо сборки или инструментов:
...
[🔨 Редактировать в Glitch](https://glitch.com/~preact-no-build-tools)

Основным недостатком этого способа является отсутствие JSX, для которого требуется этап сборки. Эргономичная и производительная альтернатива JSX описана в следующем разделе.
