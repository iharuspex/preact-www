...
show_title: false
toc: false
description: 'Быстрая альтернатива React размером 3kB, с тем же современным API.'
---
...
<jumbotron>
    ...
    <p class="tagline">Быстрая альтернатива React размером 3kB, с тем же современным API</p>
    <p class="intro-buttons">
        <a href="/guide/v10/getting-started" class="btn primary">Быстрый старт</a>
        <a href="/guide/v10/switching-to-preact" class="btn secondary">Переход на Preact</a>
    </p>
</jumbotron>
